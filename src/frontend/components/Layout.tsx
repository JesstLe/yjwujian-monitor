  ...
  compare: (
    ...
    >
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={2}
        d="M9 19H5a2 2 0 01-2-2V7a2 2 0 012-2h4m2-2h4a2 2 0 012 2v1m0 2a2 2 0 012 2h2a2 2 0 012 2v1m0 2a2 2 0 012 2h2a2 2 0 012 2v1a2 2 0 002 2h2m0 4a2 2 0 012-2 2h-2m0 4a2 2 0 01-2-2v-1m0-4a2 2 0 00-2-2h-2m0-4a2 2 0 00-2-2h-2m0-4a2 2 0 00-2-2h-4z"
      />
    </svg>
  ),
  logo: (
